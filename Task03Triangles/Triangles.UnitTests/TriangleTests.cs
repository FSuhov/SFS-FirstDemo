...
namespace Triangles.UnitTests
{
    ...
    {
        [TestMethod]
        [DataRow("first", 2, 3, 4, "second", 2, 2, 3, -1)]
        [DataRow("first", 2, 3, 4, "second", 5, 6, 8, 1)]
        [DataRow("first", 2, 3, 4, "second", 2, 3, 4, 0)]
        [DataRow("first", 2.5, 3.2, 4.9, "second", 1.8, 2.3, 3.99, -1)]
        [DataRow("first", 2_590_467_001.987, 3_256_789_000.2, 4_200_876_876.944, "second", 6_432_900_456.8, 4_000_944_599.34, 3_456_800_000.99, 1)]
